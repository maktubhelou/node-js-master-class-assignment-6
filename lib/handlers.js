                    ...
                    _data.delete("checks", checkId, function(err) {
                      ...
                      if (checksDeleted == checksToDelete) {
                        if (!deletionErrors) {
                          ...
                          callback(500, {
                            Error:
                              "Errors encountered while attempting to delete all the user's checks. All checks may not have been deleted from the system successfully."
                          });
                        }
                      }
                    });
...
// Verify if a given token id is currently falid for a given user
